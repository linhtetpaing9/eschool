...
<h3 class="text-primary">Student Edit Form</h3>
		...
		<div class="card">
			<div class="card-body"> 
				<div class="col-lg-10 mx-auto">
					...
					<form action="{{route('student.update', $student)}}" method="POST" class="form-horizontal form-bordered">
						{{ method_field('PATCH') }}
						{{csrf_field()}}
						<div class="form-body">
							<div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="name" value="{{ $student->name }}"  autofocus>
							...
							<div class="form-group row {{ $errors->has('address') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="address" value="{{$student->address}}"  autofocus>
							...
							<div class="form-group row {{ $errors->has('email') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="email" value="{{$student->email}}"  autofocus>
							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									...
									<select class="form-control myclass" name="grade_id" single="single" >
										<option value="{{$student->grade_id}}">{{$old_grade[0]->name}}</option>
							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									<select class="form-control myclass" id="section_id" name="section_id" single="single">
										...
										<option value="{{$student->section_id}}">{{$old_section[0]->name}}</option>
							...
							<div class="form-group row {{ $errors->has('contact_number') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									...
									<input type="tel" class="form-control" id="telNo" name="contact_number" value="{{ $student->contact_number }}"  placeholder="09250359280" size="20" minlength="9" maxlength="11" autofocus>
